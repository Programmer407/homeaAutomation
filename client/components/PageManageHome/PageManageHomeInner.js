...
// src
import './PageManageHomeInner.scss';
import { renderTextField } from '../../utils'

import AddHome from '../AddHomeDialog/AddHome'
import FlatButton from 'material-ui/FlatButton';

const PageManageHomeInner = props => {
  const { onSubmit, renderSubmitButton, renderMessage, onHandleNoSpaces, addAHomeDialogOpen,handleAddHomeDialogClose,handleAddHomeDialogOpen} = props;
...
export default PageManageHomeInner