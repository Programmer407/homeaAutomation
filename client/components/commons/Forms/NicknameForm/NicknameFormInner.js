...
const NicknameFormInner = props => {
	const { renderRaisedSubmitButton, onSubmit, address, addressId, oldNickname } = props
	...
	return (
		<form onSubmit={ onSubmit  }>
			...
			<Field name="newNickname" hintText={ oldNickname } label="Nickname" component={ renderTextField } autoComplete="off" autoFocus />
